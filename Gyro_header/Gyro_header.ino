...
//   angle_y_accel = -atan(accel_y_scalled/(sqrt(accel_x_scalled*accel_x_scalled+accel_z_scalled*accel_z_scalled)))*(float)rad2degree;
//   angle_x_accel = atan(accel_x_scalled/(sqrt(accel_y_scalled*accel_y_scalled+accel_z_scalled*accel_z_scalled)))*(float)rad2degree;
  //angle_y_accel = atan(accel_x_scalled/accel_z_scalled)*(float)rad2degree;
  angle_x_accel = atan2(-accel_y_scalled,accel_z_scalled)*(float)rad2degree;
  angle_y_accel = atan2(accel_x_scalled,(sqrt(accel_y_scalled*accel_y_scalled+accel_z_scalled*accel_z_scalled)))*(float)rad2degree;
...
//  Serial.print("\t"); 
  ...
  Serial.print(atan2(angle_y, angle_z) * 180/PI);
  Serial.print("\t");
  Serial.print(atan2(angle_x, sqrt(angle_y*angle_y + angle_z*angle_z)) * 180/PI);
  Serial.print("\t\n"); 
...
/*if(!isSet){
  ...
  Serial.print(angle_x-set0x);
  Serial.print("\t");
  Serial.print(angle_y-set0y);
  Serial.print("\t");
  Serial.print(angle_z-set0z);
  Serial.print("\t");
  */
